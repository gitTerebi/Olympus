...
stdsptr<eCharacterAction> eCharacterAction::sCreate(
    ...
    case eCharActionType::storageDeliveryCartAction:
        return e::make_shared<eStorageDeliveryCartAction>(c, nullptr);
    ...
    case eCharActionType::fightAction:
        return e::make_shared<FightAction>(c);
    case eCharActionType::fireFighterAction:
        return e::make_shared<FireFighterAction>(c);
