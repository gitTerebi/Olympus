...
class GameTextures {
public:
    static const std::vector<TerrainTextures>& terrain() {
        return sTerrainTextures;
    }
    static const std::vector<GodTextures>& gods() {
        return sGodTextures;
    }
    static const std::vector<BuildingTextures>& buildings() {
        return sBuildingTextures;
    }
    static const std::vector<CharacterTextures>& characters() {
        return sCharacterTextures;
    }
    static const std::vector<InterfaceTextures>& interface() {
...
private:
    ...
    static std::vector<BuildingTextures> sBuildingTextures;
    static std::vector<CharacterTextures> sCharacterTextures;
    static std::vector<InterfaceTextures> sInterfaceTextures;
    static std::vector<DestructionTextures> sDestructionTextures;
};
