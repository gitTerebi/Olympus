#include "surrounding-terrain.h"

SurroundingTerrain::SurroundingTerrain(eTile* const tile,
                                         const eWorldDirection dir) {
    tile->surroundingTerrain(mTL, mTR, mBR, mBL, mT, mR, mB, mL, dir);
}

bool SurroundingTerrain::operator()(const eTerrain t, const eTerrain tr,
