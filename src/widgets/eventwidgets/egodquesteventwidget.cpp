...
void eGodQuestEventWidget::initialize(
    ...
    godButtonL->setup(Language::zeusText(44, 391), godButton);
    ...
    idButtonL->setup(Language::zeusText(44, 357), idButton);
    addWidget(idButtonL);
    ...
    heroButtonL->setup(Language::zeusText(44, 267), mHeroButton);
