...
stdsptr<eBuilding> eBuildingReader::sRead(
    ...
    eCityId cid;
    src >> cid;
    buildingReadDbg("building: cid read", type, static_cast<int>(cid), src.position());
    stdsptr<eBuilding> b;
    switch(type) {
...
static std::vector<eSanctCost> readPyramidElementCostJson(eJsonArchive& ar) {
    int n = 0;
    ...
    for(int i = 0; i < n; i++) {
        ...
        eSanctCost c;
        ar.field((p + "wood").c_str(), c.fWood);
        ar.field((p + "marble").c_str(), c.fMarble);
        ar.field((p + "sculpture").c_str(), c.fSculpture);
        ar.field((p + "orichalc").c_str(), c.fOrichalc);
        ar.field((p + "blackMarble").c_str(), c.fBlackMarble);
        result.push_back(c);
    }
    return result;
}
...
template <typename T>
static stdsptr<eBuilding> createVendorJson(eGameBoard& board, eJsonArchive& ar, const eCityId cid) {
    const auto v = e::make_shared<T>(board, cid);
    int aid = -1, sid = 0;
    ar.field("agora", aid);
    ar.field("agoraSpaceId", sid);
    ar.addPostFunc([aid, sid, v]() {
        const auto& board = v->getBoard();
        const auto a = board.buildingWithIOID(aid);
        if(!a) return;
        const auto t = a->type();
        if(t != eBuildingType::commonAgora && t != eBuildingType::grandAgora) return;
        const auto aa = a->template ref<eAgoraBase>();
        v->setAgora(aa);
        aa->setBuilding(sid, v);
    });
...
stdsptr<eBuilding> eBuildingReader::sReadJson(
        eGameBoard& board, const eBuildingType type,
        eJsonArchive& ar) {
    const auto& wrld = board.world();
    eCityId cid{};
    ...
    case eBuildingType::palaceTile: {
        bool other = false;
        ar.field("other", other);
        const auto pt = e::make_shared<ePalaceTile>(board, other, cid);
        b = pt;
        ar.buildingRef("palace", [pt](eBuilding* bb) {
            pt->setPalace(static_cast<ePalace*>(bb));
        }, board);
    } break;
    case eBuildingType::eliteHousing: {
    ...
    case eBuildingType::oliveTree: {
        b = e::make_shared<eResourceBuilding>(board, eResourceBuildingType::oliveTree, cid);
    } break;
    case eBuildingType::vine: {
        b = e::make_shared<eResourceBuilding>(board, eResourceBuildingType::vine, cid);
    } break;
    case eBuildingType::orangeTree: {
        b = e::make_shared<eResourceBuilding>(board, eResourceBuildingType::orangeTree, cid);
    } break;
    case eBuildingType::huntingLodge: {
        b = e::make_shared<eHuntingLodge>(board, cid);
    } break;
    ...
    case eBuildingType::pier: {
        ...
        const auto p = e::make_shared<ePier>(board, o, cid);
        b = p;
        ar.buildingRef("tradePost", [p](eBuilding* bb) { p->setTradePost(bb); }, board);
    } break;
    case eBuildingType::tradePost: {
        eTradePostType tpt{};
        ar.field("tpType", tpt);
        ...
        tp->setOrientation(o);
        if(tpt == eTradePostType::pier) {
            ar.buildingRef("unpackBuilding", [tp](eBuilding* bb) { tp->setUnpackBuilding(bb); }, board);
        }
    } break;
    case eBuildingType::dairy: {
        b = e::make_shared<eDairy>(board, cid);
    ...
    case eBuildingType::growersLodge: {
        b = e::make_shared<eGrowersLodge>(board, eGrowerType::grapesAndOlives, cid);
    } break;
    case eBuildingType::orangeTendersLodge: {
        b = e::make_shared<eGrowersLodge>(board, eGrowerType::oranges, cid);
    } break;
    case eBuildingType::granary: {
        b = e::make_shared<eGranary>(board, cid);
    } break;
    ...
    case eBuildingType::horseRanch: {
        const auto hr = e::make_shared<eHorseRanch>(board, cid);
        b = hr;
        ar.buildingRef("enclosure", [hr](eBuilding* bb) {
            hr->setEnclosure(static_cast<eHorseRanchEnclosure*>(bb));
        }, board);
    } break;
    case eBuildingType::horseRanchEnclosure: {
        const auto hre = e::make_shared<eHorseRanchEnclosure>(board, cid);
        b = hre;
        ar.buildingRef("ranch", [hre](eBuilding* bb) {
            hre->setRanch(static_cast<eHorseRanch*>(bb));
        }, board);
    } break;
    case eBuildingType::olivePress: {
    ...
    case eBuildingType::foodVendor: {
        b = createVendorJson<eFoodVendor>(board, ar, cid);
    } break;
    case eBuildingType::fleeceVendor: {
        b = createVendorJson<eFleeceVendor>(board, ar, cid);
    } break;
    case eBuildingType::oilVendor: {
        b = createVendorJson<eOilVendor>(board, ar, cid);
    } break;
    case eBuildingType::wineVendor: {
        b = createVendorJson<eWineVendor>(board, ar, cid);
    } break;
    case eBuildingType::armsVendor: {
        b = createVendorJson<eArmsVendor>(board, ar, cid);
    } break;
    case eBuildingType::horseTrainer: {
        b = createVendorJson<eHorseVendor>(board, ar, cid);
    } break;
    case eBuildingType::chariotVendor: {
        b = createVendorJson<eChariotVendor>(board, ar, cid);
    } break;
    case eBuildingType::chariotFactory: {
        b = e::make_shared<eChariotFactory>(board, cid);
    } break;
    ...
    case eBuildingType::godMonument: {
        ...
        eGodQuestId id{};
        ar.field("id", id);
        b = e::make_shared<eGodMonument>(god, id, board, cid);
    } break;
    case eBuildingType::godMonumentTile: {
        const auto pt = e::make_shared<eGodMonumentTile>(board, cid);
        b = pt;
        ar.buildingRef("monument", [pt](eBuilding* bb) {
            pt->setMonument(static_cast<eGodMonument*>(bb));
        }, board);
    } break;
    case eBuildingType::bench: {
    ...
    case eBuildingType::templeZeus: {
        int sw = 0, sh = 0;
        ar.field("spanW", sw); ar.field("spanH", sh);
        b = eSanctuary::sCreate(type, sw, sh, board, cid);
    } break;
    case eBuildingType::templeStatue: {
        eGodType godType{};
        ar.field("godType", godType);
        int id = 0;
        ar.field("id", id);
        const auto ts = e::make_shared<eTempleStatueBuilding>(godType, id, board, cid);
        b = ts;
        ...
        ar.addPostFunc([&board, sanctIoid, ts]() {
            if(sanctIoid < 0) return;
            const auto bb = board.buildingWithIOID(sanctIoid);
            if(!bb) return;
            ts->setMonument(static_cast<eMonument*>(bb));
            static_cast<eMonument*>(bb)->registerElement(ts);
        });
    } break;
    case eBuildingType::templeMonument: {
        eGodType godType{};
        ...
        const auto ts = e::make_shared<eTempleMonumentBuilding>(godType, id, board, cid);
        b = ts;
        ar.buildingRef("monument", [ts](eBuilding* bb) {
            ts->setMonument(static_cast<eMonument*>(bb));
            static_cast<eMonument*>(bb)->registerElement(ts);
        }, board);
    } break;
    ...
    case eBuildingType::pyramidWall: {
        ...
        ar.field("orientation", o);
        int elevation = 0;
        ar.field("elevation", elevation);
        int special = 0;
        ar.field("special", special);
        const auto costs = readPyramidElementCostJson(ar);
        const auto ts = e::make_shared<ePyramidWall>(costs, board, o, elevation, special, cid);
        b = ts;
        ar.buildingRef("monument", [ts](eBuilding* bb) {
            ts->setMonument(static_cast<eMonument*>(bb));
            static_cast<eMonument*>(bb)->registerElement(ts);
    ...
    case eBuildingType::pyramidTop: {
        ...
        ar.field("elevation", elevation);
        const auto costs = readPyramidElementCostJson(ar);
        const auto ts = e::make_shared<ePyramidTop>(costs, board, elevation, cid);
        b = ts;
        ar.buildingRef("monument", [ts](eBuilding* bb) {
            ts->setMonument(static_cast<eMonument*>(bb));
            static_cast<eMonument*>(bb)->registerElement(ts);
    ...
    case eBuildingType::pyramidTile: {
        ...
        ar.field("elevation", elevation);
        int tileType = 0;
        ar.field("pyramidTileType", tileType);
        const auto costs = readPyramidElementCostJson(ar);
        const auto ts = e::make_shared<ePyramidTile>(costs, board, elevation, tileType, cid);
        b = ts;
        ar.buildingRef("monument", [ts](eBuilding* bb) {
            ts->setMonument(static_cast<eMonument*>(bb));
            static_cast<eMonument*>(bb)->registerElement(ts);
    ...
    case eBuildingType::pyramidPart: {
        ...
        ar.field("elevation", elevation);
        const auto costs = readPyramidElementCostJson(ar);
        const auto ts = e::make_shared<ePyramidBuildingPart>(costs, board, elevation, cid);
        b = ts;
        ar.buildingRef("monument", [ts](eBuilding* bb) {
            ts->setMonument(static_cast<eMonument*>(bb));
            static_cast<eMonument*>(bb)->registerElement(ts);
    ...
    case eBuildingType::pyramidAltar: {
        ...
        ar.field("elevation", elevation);
        const auto costs = readPyramidElementCostJson(ar);
        const auto ts = e::make_shared<ePyramidAltar>(costs, board, elevation, cid);
        b = ts;
        ar.buildingRef("monument", [ts](eBuilding* bb) {
            ts->setMonument(static_cast<eMonument*>(bb));
            static_cast<eMonument*>(bb)->registerElement(ts);
    ...
    case eBuildingType::pyramidStatue: {
        ...
        ar.field("elevation", elevation);
        eGodType gt{};
        ar.field("pyramidStatueType", gt);
        int id = 0;
        ar.field("id", id);
        const auto costs = readPyramidElementCostJson(ar);
        const auto ts = e::make_shared<ePyramidStatue>(costs, board, elevation, gt, id, cid);
        b = ts;
        ar.buildingRef("monument", [ts](eBuilding* bb) {
            ts->setMonument(static_cast<eMonument*>(bb));
            static_cast<eMonument*>(bb)->registerElement(ts);
    ...
    case eBuildingType::pyramidMonument: {
        ...
        ar.field("elevation", elevation);
        eGodType gt{};
        ar.field("pyramidMonumentType", gt);
        int id = 0;
        ar.field("id", id);
        const auto costs = readPyramidElementCostJson(ar);
        const auto ts = e::make_shared<ePyramidMonument>(costs, board, elevation, gt, id, cid);
        b = ts;
        ar.buildingRef("monument", [ts](eBuilding* bb) {
            ts->setMonument(static_cast<eMonument*>(bb));
            static_cast<eMonument*>(bb)->registerElement(ts);
    ...
    case eBuildingType::pyramidTemple: {
        ...
        ar.field("elevation", elevation);
        const auto costs = readPyramidElementCostJson(ar);
        const auto ts = e::make_shared<ePyramidTemple>(costs, board, elevation, cid);
        b = ts;
        ar.buildingRef("monument", [ts](eBuilding* bb) {
            ts->setMonument(static_cast<eMonument*>(bb));
            static_cast<eMonument*>(bb)->registerElement(ts);
    ...
    case eBuildingType::pyramidObservatory: {
        ...
        ar.field("elevation", elevation);
        const auto costs = readPyramidElementCostJson(ar);
        const auto ts = e::make_shared<ePyramidObservatory>(costs, board, elevation, cid);
        b = ts;
        ar.buildingRef("monument", [ts](eBuilding* bb) {
            ts->setMonument(static_cast<eMonument*>(bb));
            static_cast<eMonument*>(bb)->registerElement(ts);
    ...
    case eBuildingType::pyramidMuseum: {
        ...
        ar.field("elevation", elevation);
        const auto costs = readPyramidElementCostJson(ar);
        const auto ts = e::make_shared<ePyramidMuseum>(costs, board, elevation, cid);
        b = ts;
        ar.buildingRef("monument", [ts](eBuilding* bb) {
            ts->setMonument(static_cast<eMonument*>(bb));
            static_cast<eMonument*>(bb)->registerElement(ts);
